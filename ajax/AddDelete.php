<?php
//AJAX - Delete & add accounts bij Admin

//include db configuration file
include_once("config.php");

if(isset($_POST["content_txt"]) && strlen($_POST["content_pswd"])>0) 
...
{	//do we have a delete request? $_POST["recordToDelete"]
	...
	$delete_row = $mysqli->query("DELETE FROM tbladmin WHERE adminID=".$idToDelete);
