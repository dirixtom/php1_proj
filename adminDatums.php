								...
								echo "<form method='post' class='form-horizontal'>";
									echo "<div class='form-group'>";
										echo "<div class='col-sm-3'>";
											echo "<label for='username' class='col-sm-2 control-label'>". $date["dag"] . " " . $date["maand"] . " " . $date["jaar"] . "</label>";
										echo "</div>";
										echo "<div class='col-sm-6'>";
											echo "<input type='hidden' name='dateID' value='".$date['id']."'><input type='submit' class='submit' name='FormDel' value='Verwijder datum'><br /><br />";
										echo "</div>";
									echo "</div>";
								echo "</form>";
							}
